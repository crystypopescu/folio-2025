...
export class View
{
    ...
    setFocusPoint()
    {
        ...
        this.focusPoint.isTracking = false // Fixed camera mode - no player tracking
        ...
        this.focusPoint.magnet.active = false // Disabled for fixed camera mode
        this.focusPoint.magnet.multiplier = 0.25

        // Disabled for fixed camera mode - no player tracking
